...
import './ChatList.css';
import {Languages, FileText, Text, Menu, CirclePlus, Pencil, Trash2, X, User, Search} from 'lucide-react';
...
const ChatList = () => {
    ...
    const customChats = useMemo(() => {
        return chats.filter(chat => chat.type === 'custom_template')
                    .slice(0, 5); // Limit to 5 recent custom chats
    }, [chats]);
